...
class ManagerFirst: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath){
        if editingStyle==UITableViewCellEditingStyle.Delete{
            ...
            loadingNote.labelText = "Deleting the menu item"
            let objectID = posts![indexPath.row].objectId
    ...
    @IBAction func addtomen(sender: AnyObject) {
        self.performSegueWithIdentifier("addtomenu", sender: nil)
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
  
        if(segue.identifier != "addtomenu"){
            ...
            print(menuPost)
            //menuPost["media"].loadInBackground()
            //svc.imageee.file = menuPost["media"] as? PFFile
            //svc.menuImagePost = menuPost as PFObject!
